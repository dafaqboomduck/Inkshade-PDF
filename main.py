...
class PDFReader(QMainWindow):
    ...
    def apply_style(self):
        ...
        if self.dark_mode:
            ...
            self.top_frame.setStyleSheet("QFrame#TopFrame { background-color: #505050; }")
        else:
            self.setStyleSheet("background-color: #E8E8E8; color: black;")
            self.top_frame.setStyleSheet("QFrame#TopFrame { background-color: #F0F0F0; }")
